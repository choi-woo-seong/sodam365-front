...
function BankDetail() {
  ...
  const handleGoToList = () => {
    navigate("/bankBoardList"); // 🔹 "/noticelist" 페이지로 이동
  };
  ...
  />
        ...
        <div className="detail-box">
          <div className="detail-row">
            ...
            <input type="text" className="detail-text" name="g_title" id="g_title" disabled={true}/>
          </div>
          <div className="detail-row content-row">
            <div className="detail-label">내용</div>
            <textarea className="detail-text large" disabled={true}></textarea>
          </div>
        </div>
