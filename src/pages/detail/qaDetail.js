...
function QADetail() {
  ...
  const [a_comments, setComments] = useState([]);
  ...
  //   };
  //   setComments([...a_comments, newComment]);
  //   setComment("");
  // };
  ...
  const handleGoToList = () => {
    navigate("/QABoardList"); // 🔹 "/noticelist" 페이지로 이동
  };
  ...
  />
        ...
        <div className="detail-box">
          <div className="detail-row">
            ...
            <input type="text" className="detail-text" name="a_title" id="a_title" disabled={true}/>
          </div>
          <div className="detail-row content-row">
            <div className="detail-label">내용</div>
            <textarea className="detail-text large" name="a_contents" id="a_contents" disabled={true}></textarea>
          </div>
        </div>
