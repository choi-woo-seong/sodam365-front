  ...
  />
        ...
        <div className="detail-box">
          <div className="detail-row">
            ...
            <input type="text" className="detail-text" name="p_title" id="p_title" disabled={true}/>
          </div>
          <div className="detail-row">
            <div className="detail-label">금액</div>
            <input type="text" className="detail-text" name="p_price" id="p_price" disabled={true} />
          </div>
          <div className="detail-row content-row">
            <div className="detail-label">내용</div>
            <textarea className="detail-text large" name="p_contents" id="p_contents" disabled={true}></textarea>
          </div>
          <div className="detail-row">
            <div className="detail-label">링크</div>
            <input type="text" className="detail-text" name="p_link" id="p_link" disabled={true} />
          </div>
        </div>
